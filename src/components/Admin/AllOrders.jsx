          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {orders.map((order) => (
              <tr key={order._id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{order.user_id._id}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{order.user_id.username}</td>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{new Date(order.purchaseDate).toLocaleDateString()}</td>
